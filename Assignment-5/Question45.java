 ...
 * Create method show() to display information. Create another class CollegeStudent inherits Student class. Add a new member 
 * semester to it. Create default and parameterized constructors. Also override show() method that calls super class show() 
 * method and displays semester. Create another class SchoolStudent inherits Student class. Add a new member 
 ...
 * of the project : -- has array to store objects of any class(Student,  CollegeStudent or SchoolStudent) --create two CollegeStudent
 * and three SchoolStudent objects and store them inside the array -- display all records from the array -- search record on the basic
 * of rollno and check given rollno is of SchoolStudent or of CollegeStudent. --count how many students are having A grade, if for 
